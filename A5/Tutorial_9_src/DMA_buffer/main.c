...
static int drv_open(struct inode *inode, struct file *filp)
{
	printk("Tutorial_11:%s():device open\n", __FUNCTION__);
	return 0;
}

static int drv_release(struct inode *inode, struct file *filp)
{
	printk("Tutorial_11:%s():device close\n",__FUNCTION__);
	return 0;
}

static ssize_t drv_read(struct file *filp, char __user *buf, size_t count, loff_t *f_pos)
{
	printk("Tutorial_11:%s(): in read\n", __FUNCTION__);
	return 0;
}
...
static ssize_t drv_write(struct file *filp, const char __user *buf, size_t count, loff_t *f_pos)
{
	printk("Tutorial_11:%s(): in write\n", __FUNCTION__);
	return 0;
}

static long drv_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	printk("Tutorial_11:%s(): in ioctl\n", __FUNCTION__);
	return 0;
...
static int __init init_modules(void)
{
	...
	dev_major = MAJOR(dev);
	dev_minor = MINOR(dev);
	printk("Tutorial_11:%s():register chrdev(%d,%d)\n",__FUNCTION__,dev_major,dev_minor);
	...
	printk("Tutorial_11:%s():allocate dma buffer\n",__FUNCTION__);
...
static void __exit exit_modules(void)
{
	...
	kfree(dma_buf);
	printk("Tutorial_11:%s():free dma buffer\n",__FUNCTION__);

	printk("Tutorial_11:%s():unregister chrdev\n",__FUNCTION__);
	unregister_chrdev_region(dev, 1);

	printk("Tutorial_11:%s():..............End..............\n",__FUNCTION__);
}
